...
// Legacy: "chat" is now an alias for chat_completions.
...
pub fn built_in_model_providers(
    ...
    let cc = create_chat_completions_provider;
    ...
    [
        ...
        (
            ...
            cc(
                ...
                "OPENCODE_API_KEY",
                Some("Get your API key at https://opencode.ai"),
            ),
        ),
        (
            "opencode-go",
        ...
        (
            ...
            cc(
                ...
                "OPENROUTER_API_KEY",
                Some("Get your API key at https://openrouter.ai/keys"),
            ),
        ),
        // --- Major AI providers ---
        (
            ...
            cc(
                ...
                "ANTHROPIC_API_KEY",
                Some("Get your API key at https://console.anthropic.com/settings/keys"),
            ),
        ),
        (
            "google-gemini",
            cc(
                ...
                "GEMINI_API_KEY",
                Some("Get your API key at https://aistudio.google.com/apikey"),
            ),
        ),
        // --- Inference providers ---
        (
            ...
            cc(
                ...
                "GROQ_API_KEY",
                Some("Get your API key at https://console.groq.com/keys"),
            ),
        ),
        (
            "together",
            cc(
                ...
                "TOGETHER_API_KEY",
                Some("Get your API key at https://api.together.xyz/settings/api-keys"),
            ),
        ),
        (
            "fireworks",
            cc(
                ...
                "FIREWORKS_API_KEY",
                Some("Get your API key at https://fireworks.ai/account/api-keys"),
            ),
        ),
        (
            "mistral",
            cc(
                ...
                "MISTRAL_API_KEY",
                Some("Get your API key at https://console.mistral.ai/api-keys"),
            ),
        ),
        (
            "deepseek",
            cc(
                ...
                "DEEPSEEK_API_KEY",
                Some("Get your API key at https://platform.deepseek.com/api_keys"),
            ),
        ),
        (
            "perplexity",
            cc(
                ...
                "PERPLEXITY_API_KEY",
                Some("Get your API key at https://www.perplexity.ai/settings/api"),
            ),
        ),
        (
            "xai",
            cc(
                ...
                "https://api.x.ai/v1",
                "XAI_API_KEY",
                Some("Get your API key at https://console.x.ai"),
            ),
        ),
        ...
        (
            ...
            cc(
                ...
                Some("Get your API token at https://huggingface.co/settings/tokens"),
            ),
        ),
        (
            "cohere",
            cc(
                ...
                "COHERE_API_KEY",
                Some("Get your API key at https://dashboard.cohere.com/api-keys"),
            ),
        ),
        (
            "ai21",
            cc(
                ...
                "AI21_API_KEY",
                Some("Get your API key at https://studio.ai21.com/account/api-key"),
            ),
        ),
        (
            "replicate",
            cc(
                ...
                "REPLICATE_API_TOKEN",
                Some("Get your API token at https://replicate.com/account/api-tokens"),
            ),
        ),
        (
            "anyscale",
            cc(
                ...
                "ANYSCALE_API_KEY",
                Some("Get your API key at https://app.endpoints.anyscale.com/"),
            ),
        ),
        (
            "deepinfra",
            cc(
                ...
                "DEEPINFRA_API_KEY",
                Some("Get your API key at https://deepinfra.com/dash/api_keys"),
            ),
        ),
        (
            "sambanova",
            cc(
                ...
                "SAMBANOVA_API_KEY",
                Some("Get your API key at https://cloud.sambanova.ai/apis"),
            ),
        ),
        (
            "novita",
            cc(
                ...
                "NOVITA_API_KEY",
                Some("Get your API key at https://novita.ai/settings/api-keys"),
            ),
        ),
        (
            "nvidia",
            cc(
                ...
                "NVIDIA_API_KEY",
                Some("Get your API key at https://build.nvidia.com/settings/api-key"),
            ),
        ),
        // --- Cloud providers ---
        (
            ...
            cc(
                ...
                Some("Get your API token at https://dash.cloudflare.com/profile/api-tokens"),
            ),
        ),
        (
            "azure-openai",
            cc(
                ...
                Some("Set AZURE_OPENAI_ENDPOINT and AZURE_OPENAI_DEPLOYMENT env vars"),
            ),
        ),
        (
            "ibm-watsonx",
            cc(
                "IBM watsonx",
                "https://us-south.ml.cloud.ibm.com/ml/v1/openai",
                "WATSONX_API_KEY",
                Some("Set WATSONX_URL and WATSONX_PROJECT_ID env vars"),
            ),
        ),
        ...
        (
            ...
            cc(
                ...
                "ZHIPU_API_KEY",
                Some("Get your API key at https://open.bigmodel.cn/usercenter/apikeys"),
            ),
        ),
        (
            "moonshot",
            cc(
                ...
                "MOONSHOT_API_KEY",
                Some("Get your API key at https://platform.moonshot.cn/console/api-keys"),
            ),
        ),
        (
            "minimax",
            cc(
                ...
                "MINIMAX_API_KEY",
                Some("Get your API key at https://platform.minimaxi.com/user-center/apikeys"),
            ),
        ),
    ]
    .into_iter()
...
fn create_chat_completions_provider(
    name: &str,
    base_url: &str,
    env_key: &str,
    ...
    ModelProviderInfo {
        ...
        env_key_instructions: env_key_instructions.map(|s| s.into()),
        experimental_bearer_token: None,
        auth: None,
        aws: None,
...
/// All built-in provider IDs that cannot be overridden via user config.
pub const BUILT_IN_PROVIDER_IDS: &[&str] = &[
    OPENAI_PROVIDER_ID,
